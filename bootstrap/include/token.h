...
enum
{
    ...
    FRX_TOKEN_TYPE_KW_LOOP,
    FRX_TOKEN_TYPE_KW_WHILE,
    FRX_TOKEN_TYPE_KW_DO,
    FRX_TOKEN_TYPE_KW_TRAIT,
    FRX_TOKEN_TYPE_KW_IMPL,
    FRX_TOKEN_TYPE_KW_SELF_LOWER,
    FRX_TOKEN_TYPE_KW_SELF_UPPER,
    FRX_TOKEN_TYPE_KW_FN,
    FRX_TOKEN_TYPE_KW_LET,
